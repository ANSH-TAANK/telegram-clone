    ...
    <div>
      ...
      <main className="flex-1 flex flex-col items-center px-4 sm:px-6 text-center gap-20">
        <div className="max-w-4xl space-y-8 relative">
          <div className="absolute inset-0 -z-10 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-blue-950/20 dark:via-indigo-950/20 dark:to-purple-950/20 rounded-3xl blur-3xl scale-150 opacity-60">
          </div>
          ...
          <div className="max-w-4xl space-y-8 relative">
            ...
            <p className="text-xl test-muted-foreground max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center">
            <FeatureCard 
              ...
              Chat with friends, family, and colleagues seamlessly."            
            />
            <FeatureCard
              icon={Video}
          ...
          <div className="w-full max-w-4xl">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              ...
              communicate. Start your journey with Beam today — it&apos;s completely
              free.
            </p>
  ...
  <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
    ...
    <div className="border-t mt-8 pt-6 text-center">
      <p className="text-xs text-muted-foreground">
        ...
        educational. In the event of any infringement, please contact us and we
        will remove/alter the content immediately.
      </p>
    </div>
  </div>
</footer>
